...
<form name="login" id="loginF" onSubmit="shopLogin(); return false">
	...
	<p class="errors" style="display:block;">Неправильный логин и (или) пароль</p>
	<div class="newLine">
		...
		<p class="links">
			<a href="/user/?reg" title="Перейти на страницу регистрации" class="margLink">Регистрация</a>
			<a href="/user/?restore" title="Перейти на страницу востановления пароля">Забыли пароль?</a>
		</p>
	</div>
</form>