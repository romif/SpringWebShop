	...
	<p style="text-align: center">
		<span style="color: #ffff00"> <span
			style="font-family: Verdana"> <strong> <span
					style="font-size: large"> <span style="font-size: medium"><br>
								<br>Velcom</span></span></strong></span></span> <span style="font-family: Verdana"> <strong><span
				style="font-size: large"><span style="font-size: medium"><span
						style="color: #ffffff"> - </span> <span
						style="color: rgb(0, 0, 255);">8 <span
							style="font-size: small;">(XXX)</span> XXX-XX-XX
