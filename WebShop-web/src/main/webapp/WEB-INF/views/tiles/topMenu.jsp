	...
	<tbody>
		<tr id="topMenuRow">
			...
			<td><a href="/index" class=main alt="Главная"
				<%if (!request.getParameterNames().hasMoreElements()) {%> id="active"
				<%}%>>Главная</a></td>
			...
			<td><a href="/index?findtext" alt="Расширенный поиск"
				<%if (request.getParameter("findtext") != null) {%> id="active" <%}%>>Расширенный
					поиск</a></td>

			<td><a href="/index?delivery" class=delivery
